...
void CViewRender::DrawOpaqueRenderables( ClientWorldListInfo_t& info, CRenderList &renderList )
{
	...
	//---------------------------------------------------------------------------
	//TOWERS CODE - PRE Draw custom meshes here. (Routed to player_displays.cpp)
	Pre_DrawExtras(); //defined in c_sdk_player.h
	//---------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------------
	//TOWERS CODE - POST Draw custom meshes here. (Routed to player_displays.cpp)
	Post_DrawExtras(); //defined in c_sdk_player.h
	//---------------------------------------------------------------------------
